# bottlim.py
# from https://raw.githubusercontent.com/krazedkrish/bottlim/master/bottlim.py
...
class PlimTemplate(BaseTemplate):
    def prepare(self, **options):
        ...
        lookup = TemplateLookup(directories=self.lookup, preprocessor = preprocessor, **options)
        if self.source:
